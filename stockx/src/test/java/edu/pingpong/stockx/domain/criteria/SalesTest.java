...
public class SalesTest {
    ...
    public void checkBids() {
        ...
        assertEquals(1, sales.checkCriteria(sneaker).size());
    }

    @Test
    public void checkSalesEmpty() {

        Bid bid1 = new Bid("15", 2);
        Bid bid2 = new Bid("45", 6);
        Ask ask1 = new Ask("45", 3);

        sneaker.add(bid1);
        sneaker.add(bid2);
        sneaker.add(ask1);

        assertEquals(0, sales.checkCriteria(sneaker).size());
    }
}
